module Fl::Framework::Attachment::ActiveStorage
  ...
  module Macros
    ...
    module ClassMethods
      ...
      #     }, wms: {
      #       small: { resize: '64x64', watermark: "src/images/watermarks/wm200.png" },
      #       medium: { resize: '100x100', watermark: "src/images/watermarks/wm400.png"},
      #       large: { resize: '400x400', watermark: "src/images/watermarks/wm400.png" },
      #       original: { watermark: "src/images/watermarks/wm400.png" }
      #     }
      # end
      # ```
