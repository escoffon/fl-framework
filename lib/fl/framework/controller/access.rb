module Fl::Framework::Controller
  ...
  module Access
    ...
    # Wrapper around the service {Fl::Service::Base#class_allow_op?} method.
    # Calls the service method and then checks if it was successful; if not, calls {#error_response}
    # and returns +false+.
    # On success, returns +true+.
    #
    # @param srv [Fl::Service::Base] A service object to use for the get and check call.
    ...
    # Wrapper around the service {Fl::Service::Base#get_and_check} method.
    # Calls the service method and then checks if it was successful; if not, calls {#error_response}
    # and returns +false+.
    # On success, returns +true+.
    ...
    #  the {Fl::Service::Base#get_and_check} method as is.
    #
