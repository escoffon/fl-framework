module Fl::Framework::Core
  ...
  module AttributeFilters
    ...
    module InstanceMethods
      ...
      # This filter wraps the {Fl::Framework::Core::HtmlHelper.strip_dangerous_elements} helper method.
      #
      # @param attr [Symbol, String] The attribute name.
      ...
      def html_strip_dangerous_elements(attr, value)
        Fl::Framework::Core::HtmlHelper.strip_dangerous_elements(value)
      end

      # HTML filter to return text only.
      # This filter wraps the {Fl::Framework::Core::HtmlHelper.text_only} helper method.
      #
      # @param attr [Symbol, String] The attribute name.
      # @param value [String] The initial value.
      #
    ...
    # - Registers the methods in {Fl::Framework::AttributeFilters::ClassMethods} as class methods of the
    #   including class.
    # - Registers the methods in {Fl::Framework::AttributeFilters::InstanceMethods} as instance methods in the
    #   including class.
