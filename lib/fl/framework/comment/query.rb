module Fl::Framework::Comment
  ...
  module Query
    ...
    # This method builds two lists, one that contains the fingerprints of authors whose comments to return
    # in the query, and one of authors whose comments to ignore in the query.
    #
    ...
    # @option opts [Array<Object>, Object] :except_authors If given, return only comments
    #  not generated by the given author or, if the value is an array, authors.
    #  See the documentation for *:only_authors*.
    # @option opts [Array<Object>, Object] :only_groups If present, an array of group
    ...
    # @option opts [Array<Object>, Object] :except_groups If given, return only comments
    ...
    # Sets up the parameters for the time-related filters.
