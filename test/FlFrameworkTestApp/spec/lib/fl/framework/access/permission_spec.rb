...
RSpec.describe Fl::Framework::Access::Permission, type: :model do
  before(:example) do
    cleanup_permission_registry([ TestPermissionOne::NAME, TestPermissionTwo::NAME,
                                  TestPermissionThree::NAME, TestPermissionFour::NAME,
                                  TestPermissionFive::NAME, TestPermissionSix::NAME ])
